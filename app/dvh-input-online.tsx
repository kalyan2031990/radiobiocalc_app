/**
 * DVH Input Screen — pick CSV/TXT and parse via API server.
 */
...
export default function DVHInputOnlineScreen() {
        ...
        <View className="gap-6 pb-8 px-4 pt-4">
          <View className="gap-2">
            ...
            <Text className="text-sm leading-relaxed" style={{ color: colors.muted }}>
              Import TPS .csv / .txt or multi-select (PTV + OARs). API: {getApiBaseUrl()}
            </Text>
          </View>
